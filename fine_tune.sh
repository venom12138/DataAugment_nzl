...
CUDA_VISIBLE_DEVICES=0 python3 fine_tune.py --no 2 --name finetune --dataset cifar10 --model resnet --layers 56 --resume /home/yu-jw19/venom/ISDA-for-Deep-Networks/CIFAR/ISDA\ test/cifar10_resnet-56_tristages/no_2_lambda_0_0.5_standard-Aug_/checkpoint/checkpoint.pth.tar # --optimizer_resume
