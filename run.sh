...
CUDA_VISIBLE_DEVICES=0 python3 train_fourstages.py --no 3 --name fourstages --dataset cifar10 --model resnet --layers 56 --kl_div
# CUDA_VISIBLE_DEVICES=0 python3 train_fourstages.py --no 2 --name fourstages --dataset cifar10 --model resnet --layers 56 
CUDA_VISIBLE_DEVICES=0 python3 train_tristages.py --no 3 --name tristages --dataset cifar10 --model resnet --layers 56 --kl_div
